    ...
    describe('after the GET rubric resolves', () => {
      ...
      describe('adjusting a score and submitting', () => {
        it('redirects', async () => {
          ...
          await user.click(await within(weight1.parentElement!.parentElement!).findByLabelText('5'))

          const weight2 = await findByText(/Weight 2/)
          await user.click(await within(weight2.parentElement!.parentElement!).findByLabelText('1'))
